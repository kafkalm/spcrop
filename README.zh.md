...
- 缩放图层时按住 Shift 可保持等比
- 活动图层支持顶部旋转手柄拖拽旋转
- 旋转图层时按住 Shift 可按 15° 角度吸附
- 支持 `Cmd/Ctrl + Z` 撤销最近一步编辑
- 内置 AI 文生图 / 图生图面板
- 图生图来源支持当前框选 / 活动图层 / 素材区选中图 / 上传文件
- Gemini 模型预设支持 NanoBanana / NanoBanana Pro / NanoBanana 2
- 鼠标滚轮平移画布（支持纵向/横向）
- 中键拖动画布
- 修饰键 + 滚轮缩放画布（修饰键可配置）
- 顶部/左侧像素标尺
