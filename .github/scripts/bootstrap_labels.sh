...
create_or_update "status:backlog" "cfd3d7" "Backlog"
create_or_update "status:ready" "bfdadc" "Ready"
create_or_update "status:in-progress" "0052cc" "In progress"
create_or_update "status:review" "5319e7" "In review"
create_or_update "status:blocked" "b60205" "Blocked"
create_or_update "status:done" "0e8a16" "Done"
